                            ...
                            <tbody>
                                {Categories.map(({ id, cate_name, image, desc }, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>{desc}</td>
                                        <td>
                                            <Link className="btn btn-primary mr-2" to={`/admin/category-list/${id}`}><i class="fas fa-info"></i></Link>
                                            <Link className="btn btn-primary mr-2" to={`/admin/edit-category/${id}`}><i class="far fa-edit"></i></Link>
                                            <button className="btn btn-danger" onClick={() => deleteCategory(id)} ><i class="fas fa-trash"></i></button>
