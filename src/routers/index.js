...
//Blogs
import Blogs from '../pages/views/Admin/Blogs/Blogs';
import AddBlogs from '../pages/views/Admin/Blogs/AddBlogs';
...
import EditBlogs from '../pages/views/Admin/Blogs/EditBlogs';
                    ...
                    <MainAdmin>
                        <Switch>
                            ...
                            <Route path='/admin/blogs'>
                                <Blogs blogs={blogs} onRemoveBlogs={deleteBlogs} cateblogs={cateblogs} /></Route>
                            <Route path='/admin/add-blogs'>
                                <AddBlogs onAddBlogs={onHandleAddBlogs} cateblogs={cateblogs} /></Route>
                            <Route path='/admin/edit-blogs/:id'>
                                <EditBlogs blogs={blogs} onUpdateBlogs={onHandleUpdateBlogs} cateblogs={cateblogs} />  </Route>
                        </Switch>
                    </MainAdmin>
                </Route>
